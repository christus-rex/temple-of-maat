...
check(version.version === "5.2.2", `Expected version 5.2.2; found ${version.version}.`);
...
check(serviceWorker.includes("temple-maat-pwa-v5.2-2026-08-14-r3"), "Service worker cache version was not advanced.");
